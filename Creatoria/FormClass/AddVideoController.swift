...
class AddVideoController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    let type = ["Footage", "Timelapse", "Animation"]
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        ...
        let newVideo = Assets(context: self.context)
        
        newVideo.name = nameTextField.text
        newVideo.type = typeTextField.text
        newVideo.symbol = symbolNames[index]
        newVideo.source = sourceTextField.text
        newVideo.file_extension = file_extensionTextField.text
        newVideo.file_type = "Video"
    ...
    func invalidType(_ value: String) -> String? {
        ...
        if !(value == "Footage" || value == "Timelapse" || value == "Animation")
        {
