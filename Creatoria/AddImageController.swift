...
class AddImageController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        ...
        let newImage = Assets(context: self.context)
        
        newImage.name = nameTextField.text
        newImage.type = typeTextField.text
        newImage.symbol = symbolNames[index]
    ...
    func invalidType(_ value: String) -> String? {
        ...
        if !(value == "Photo" || value == "Graphic" || value == "Vector")
        {
    ...
    func checkValidForm() {
        if(nameValidate.isHidden && sourceValidate.isHidden && desc_Validate.isHidden && file_locationValidate.isHidden && file_extensionValidate.isHidden && type_extensionValidate.isHidden)
        {
